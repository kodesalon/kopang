...
> 선착순 이벤트 주문 처리 플랫폼 — 공정성 보장 대기열 아키텍처 기반

---

## 프로젝트 개요

**Kopang**은 선착순 이벤트 상품을 다수의 사용자가 동시에 주문하는 고트래픽 상황에서 **공정성(Fairness)** 과 **일관성(Consistency)** 을 보장하는 커머스 서버입니다.
...
- **원자적(Atomic)** 재고 예약으로 중복/초과 차감 방지
