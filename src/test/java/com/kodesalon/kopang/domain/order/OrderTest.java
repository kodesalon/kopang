...
class OrderTest {
	...
	class OrderPay {
		...
		@DisplayName("주문 결제 호출 시 주문 상태가 PAYMENT_IN_PROGRESS 일 경우 결제가 완료된다")
		@Test
		void pay() {
		...
		@DisplayName("주문 결제 호출 시 주문 상태가 CANCELLED 거나 PAID 이면 예외가 발생한다")
		@ParameterizedTest
	...
	class OrderCancel {
		...
		@DisplayName("주문 취소 호출 시 주문 상태가 CANCELLED 거나 PAID 이면 예외가 발생한다")
		@ParameterizedTest
